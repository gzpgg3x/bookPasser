...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Branch.branchphone'
        db.add_column(u'ribbit_app_branch', 'branchphone',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=14, blank=True),
                      keep_default=False)


        # Changing field 'Branch.branchname'
        db.alter_column(u'ribbit_app_branch', 'branchname', self.gf('django.db.models.fields.CharField')(max_length=80))

    def backwards(self, orm):
        # Deleting field 'Branch.branchphone'
        db.delete_column(u'ribbit_app_branch', 'branchphone')


        # Changing field 'Branch.branchname'
        db.alter_column(u'ribbit_app_branch', 'branchname', self.gf('django.db.models.fields.CharField')(max_length=50))
