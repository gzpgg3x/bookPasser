...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'bookPasser.message'
        db.add_column(u'ribbit_app_bookpasser', 'message',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'bookPasser.message'
        db.delete_column(u'ribbit_app_bookpasser', 'message')
