...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Branch'
        db.create_table(u'ribbit_app_branch', (
        ...
        db.send_create_signal(u'ribbit_app', ['Branch'])

        # Adding model 'Shout'
        db.create_table(u'ribbit_app_shout', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('count', self.gf('django.db.models.fields.CharField')(max_length=5, blank=True)),
            ('book', self.gf('django.db.models.fields.CharField')(max_length=60, blank=True)),
            ('branchname', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('date_created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('date_modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
        ))
        db.send_create_signal(u'ribbit_app', ['Shout'])


    def backwards(self, orm):
        # Deleting model 'Branch'
        db.delete_table(u'ribbit_app_branch')

        # Deleting model 'Shout'
        db.delete_table(u'ribbit_app_shout')
