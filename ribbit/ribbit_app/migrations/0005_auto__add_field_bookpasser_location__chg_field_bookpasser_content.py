...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'bookPasser.content'
        db.alter_column(u'ribbit_app_bookpasser', 'content', self.gf('django.db.models.fields.CharField')(max_length=40))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'bookPasser.content'
        db.alter_column(u'ribbit_app_bookpasser', 'content', self.gf('django.db.models.fields.CharField')(max_length=140))
