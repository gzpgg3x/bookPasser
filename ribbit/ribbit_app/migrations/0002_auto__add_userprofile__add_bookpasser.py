...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'ribbit_app_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'ribbit_app', ['UserProfile'])

        # Adding M2M table for field follows on 'UserProfile'
        db.create_table(u'ribbit_app_userprofile_follows', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('from_userprofile', models.ForeignKey(orm[u'ribbit_app.userprofile'], null=False)),
            ('to_userprofile', models.ForeignKey(orm[u'ribbit_app.userprofile'], null=False))
        ))
        db.create_unique(u'ribbit_app_userprofile_follows', ['from_userprofile_id', 'to_userprofile_id'])

        # Adding model 'bookPasser'
        db.create_table(u'ribbit_app_bookpasser', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'ribbit_app', ['bookPasser'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'ribbit_app_userprofile')

        # Removing M2M table for field follows on 'UserProfile'
        db.delete_table('ribbit_app_userprofile_follows')

        # Deleting model 'bookPasser'
        db.delete_table(u'ribbit_app_bookpasser')
